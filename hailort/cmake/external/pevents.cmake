...
if(NOT pevents_POPULATED)
    ...
    if (NOT HAILO_EXTERNALS_EXCLUDE_TARGETS)
        add_library(pevents STATIC EXCLUDE_FROM_ALL ${HAILO_EXTERNAL_DIR}/pevents-src/src/pevents.cpp)
        target_include_directories(pevents PUBLIC ${HAILO_EXTERNAL_DIR}/pevents-src/src)
